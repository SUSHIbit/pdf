...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mb-8">
        ...
        <p class="text-gray-600">Upload a PDF, DOCX, or TXT file to generate questions and answers.</p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md hover:border-cyan-400 transition-colors">
    ...
    <div class="mt-6 bg-gray-50 rounded-md p-4">
        ...
        <ul class="text-sm text-gray-600 space-y-1">
            ...
            <li>• Generated: Up to 10 questions and answers</li>
        </ul>
    </div>
</div>
@endsection